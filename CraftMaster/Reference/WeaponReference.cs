...
public class WeaponReference : IEnchantmentReference, IEnhancementReference, IMaterialsReference
{
    ...
    /// 轻型武器
    /// </summary>
    public OrderedDictionary<string, string> SimpleWeaponTypes { get; } = new(StringComparer.OrdinalIgnoreCase)
    {
        #region 轻型
    ...
    /// 军用武器
    /// </summary>
    public OrderedDictionary<string, string> MartialWeaponTypes { get; } = new(StringComparer.OrdinalIgnoreCase)
    {
        #region 轻型
    ...
    /// 异种武器
    /// </summary>
    public OrderedDictionary<string, string> ExoticWeaponTypes { get; } = new(StringComparer.OrdinalIgnoreCase)
    {
        #region 轻型
    ...
    private void InitWeaponEnchantmentData()
    {
        ...
        acidGroup.AddEnchantment(new()
        {
            ...
            Point = 1,
            CasterLevel = 10,
            AddApplyChecker = EnchantmentData.CheckerHasMagic(OtherReference.AcidArrowAbility)
        });
        acidGroup.AddEnchantment(new()
        {
            Key = "CorrosiveBurst",
        ...
        flameGroup.AddEnchantment(new()
        {
            ...
            AddApplyChecker = EnchantmentData.Or(
                EnchantmentData.CheckerHasMagic(OtherReference.FlameStrike),
                EnchantmentData.CheckerHasMagic(OtherReference.FireBall))
        });
        flameGroup.AddEnchantment(new()
        {
            Key = "FlamingBurst",
        ...
        iceGroup.AddEnchantment(new()
        {
            ...
            Point = 1,
            CasterLevel = 10,
            AddApplyChecker = EnchantmentData.CheckerHasMagic(OtherReference.IceStorm)
        });
        iceGroup.AddEnchantment(new()
        {
            Key = "IcyBurst",
        ...
        lightningGroup.AddEnchantment(new()
        {
            ...
            CasterLevel = 10,
            AddApplyChecker = EnchantmentData.Or(
                EnchantmentData.CheckerHasMagic(OtherReference.CallLightning),
                EnchantmentData.CheckerHasMagic(OtherReference.LightningBolt)),
        });
        lightningGroup.AddEnchantment(new()
        {
            Key = "ShockingBurst",
        ...
        specialGroup.AddEnchantment(new()
        {
            ...
            Point = 1,
            CasterLevel = 7,
            AddApplyChecker = EnchantmentData.CheckerHasMagic(OtherReference.CatsGrace)
        });
        specialGroup.AddEnchantment(new()
        {
            Key = "GhostTouch",
        ...
        specialGroup.AddEnchantment(new()
        {
            ...
            Point = 3,
            CasterLevel = 7,
            AddApplyChecker = EnchantmentData.CheckerHasMagic(OtherReference.Haste)
        });
        specialGroup.AddEnchantment(new()
        {
            Key = "BrilliantEnergy",
    ...
    {
        string prototype;
        if (SimpleWeaponTypes.TryGetValue(equipType, out prototype))
        {
            return prototype;
        }

        if (MartialWeaponTypes.TryGetValue(equipType, out prototype))
        {
            return prototype;
        }

        if (ExoticWeaponTypes.TryGetValue(equipType, out prototype))
        {
            return prototype;
        }

        Main.Logger.Error($"Weapon type : {equipType} not found!");
        return null;
    }
}